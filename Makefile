...
messageparsercxx: c_messageparser.cpp c_messageparser.h c_messageparser_defines.h
	$(cc) $(CXXFLAGS) -c -Wall -Werror -fpic c_messageparser.cpp -o c_messageparserxx.o -lpthread -lrt
	$(cc) $(CXXFLAGS) -shared -o libc_messageparsercxx.so c_messageparserxx.o

testscxx: messageparser libc_messageparsercxx.so
